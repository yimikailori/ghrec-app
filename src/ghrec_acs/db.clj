...
(defn update-last-recovery-attempt [values]
	(proc-update-last-recovery-attempt values))

(defn get-sweep-candidates [values]
	(proc-get-sweep-candidates values))

(defn get-recovery-candidates [values]
	(proc-get-recovery-candidates values))

(defn get-loan-balance [values]
	(get-loanbalance values))

(defn insert-attempt-recovery [values]
	(insert-recovery-attempt values))

(defn update-recovery-result [values]
	(proc-update-recovery-status values))
